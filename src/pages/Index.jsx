    ...
    <Container centerContent maxW="container.md" height="100vh" display="flex" flexDirection="column" justifyContent="center" alignItems="center">
      <VStack spacing={8}>
        ...
        <Text fontSize="lg" textAlign="center">
          Hi, I'm John Doe, a passionate software developer specializing in front-end development and UI/UX design. I love creating beautiful and functional web applications.
        </Text>
        <HStack spacing={4}>
